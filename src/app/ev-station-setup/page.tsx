    ...
    <div className="pt-20">
      <Section className="bg-primary text-white py-24 relative overflow-hidden">
         ...
         <div className="section-container relative z-10">
            <h1 className="text-5xl md:text-7xl font-stencil uppercase mb-6">EV Station <br/> <span className="text-secondary italic underline decoration-secondary/30">Turnkey Setup</span></h1>
             ...
             {steps.map((step, i) => (
                <div key={i} className={`flex flex-col lg:flex-row items-center gap-12 lg:gap-24 ${i % 2 === 0 ? "" : "lg:flex-row-reverse"}`}>
                   <div className="flex-1 w-full text-center lg:text-left space-y-4">
                      <span className="text-6xl font-stencil text-primary/10">0{i + 1}</span>
                      <h3 className="text-3xl font-bold uppercase">{step.title}</h3>
      ...
      <Section className="bg-gray-50 py-24">
         <div className="section-container text-center max-w-4xl mx-auto space-y-8">
            <h2 className="text-4xl font-stencil uppercase">Start Your Journey Today</h2>
